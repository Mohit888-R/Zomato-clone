...
<div className='px-5 py-2'>
  ...
  <div>
    <div>
      <p className='text-xl text-gray-700 py-5 px-1'>Already have an account? <Link to="/login" className='text-red-600'>Log in</Link> or <Link to="/" className='text-orange-500 self-center'>Skip</Link></p>
    </div>
  </div>
</div>
