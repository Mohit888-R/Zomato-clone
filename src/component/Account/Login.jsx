...
<div class="relative m-5 mb-2">
    <input type="text" id="floating_outlined_password" name='password' value={password}  onChange={(e)=>setPassword(e.target.value)} class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-00 bg-transparent rounded-lg border border-gray-600 appearance-none dark:text-gray400 dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
...
<div className='px-5 pb-3 py-2 flex'>
  ...
  <label for='term' className='self-center text-xs px-1'>Remember me</label>
</div>
...
<div className='px-5 py-2'>
  ...
  <div className='w-full border-2 rounded-lg py-2 cursor-default' type="dark"   onClick={handleGoogleIn}>
  ...
  <div>
    <div>
      <p className='text-xl text-gray-700 py-5 px-1'>New to Zomato? <Link to="/register" className='text-red-600'>Sign up</Link> or <Link to="/" className='text-orange-500 self-center'>Skip</Link></p>
    </div>
  </div>
</div>
