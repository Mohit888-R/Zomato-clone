...
function Collections() {
  return (
    <div className='md:w-10/12 md:justify-center md:m-auto md:px-0 py-5 px-10'>
        ...
        <Link to="/order/nightlife" className='md:flex md:font-normal md:text-red-400 md:item-center md:m-auto hidden' >All collection in Jaipur <BsFillCaretRightFill className='self-center ml-2'/></Link>
        </div>
        ...
        <Link to="/order/nightlife" className='flex font-normal text-red-400 item-center m-auto md:hidden py-5' >All collection in Jaipur <BsFillCaretRightFill className='self-center ml-2'/></Link>
    </div>
  )
}
