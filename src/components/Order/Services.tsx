  ...
  return (
    ...
    <div className='lg:m-auto lg:justify-center lg:w-10/12  px-10 pt-10 pb-2 '>
        <div className='flex  sm:gap-10'>
       {
            ...
            <Link key={index}  href={datas.router}  onClick={()=>setactive(index)}  className={`${ active ===index ? "border-b-2 lg:border-b-4 sm:pb-3 -mb-2 border-red-500 sm:p-2 rounded-sm transform duration-200 ease-in-out ":"sm:p-2"}`}>
