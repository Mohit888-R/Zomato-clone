  ...
  return (
    <div>
        <div className='md:flex md:w-10/12 md:m-auto md:justify-center md:py-5 hidden'>
            ...
            <Link href='/login'> <button className='px-5 border  p-2 rounded-md mx-5 bg-gray-50 hover:bg-gray-100 active:scale-105 hover:text-black hover:border-black transform duration-200 ease-in-out'>  Log in </button> </Link>
            <Link href='/register'> <button className='px-5 border  p-2 rounded-md bg-gray-50 hover:bg-gray-100 active:scale-105 hover:text-black hover:border-black transform duration-200 ease-in-out'>  Sign up  </button> </Link>
            </div>
        </div> 
